...
public class TestKafkaFilterManager
{
    ...
    {
        Domain testDomain = Domain.singleValue(BIGINT, 1L);
        assertThat(KafkaFilterManager.getMinMaxValues(testDomain)).isEqualTo(new KafkaFilterManager.MinMax(1L, 1L));
        ...
        testDomain = multipleValues(BIGINT, ImmutableList.of(3L, 8L));
        assertThat(KafkaFilterManager.getMinMaxValues(testDomain)).isEqualTo(new KafkaFilterManager.MinMax(3L, 8L));
        assertThat(KafkaFilterManager.filterRangeByDomain(testDomain)).isPresent();
        ...
        assertThat(KafkaFilterManager.getMinMaxValues(testDomain)).isEqualTo(new KafkaFilterManager.MinMax(2L, 4L));
        assertThat(KafkaFilterManager.filterRangeByDomain(testDomain)).isPresent();
